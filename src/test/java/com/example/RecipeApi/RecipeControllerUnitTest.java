...
import com.example.RecipeApi.contollers.RecipeControllerClass;
...
//only the web layer is necessary. Your services are being mocked.
@WebMvcTest(RecipeControllerClass.class)
@ContextConfiguration(classes = RecipeApiApplication.class)
//set the test profile to active
@ActiveProfiles("test")
public class RecipeControllerUnitTest {

    //indicate you'll be mocking the RecipeService
    @MockBean
    ...
    public void testGetRecipeByIdNormalBehavior() throws Exception {
        ...
        when(recipeService.getRecipeById(anyLong()))
                //...return the above defined recipe
                .thenReturn(recipe);
    ...
    public void testGetAllRecipesFailureBehavior() throws Exception {
        //when getAllRecipes() is called throw new NoSuchRecipeException with a random message
    ...
    public void testCreateNewRecipeSuccessBehavior() throws Exception {
        ...
        // to work comment out matchers import
