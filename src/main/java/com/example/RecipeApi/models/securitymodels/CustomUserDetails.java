package com.example.RecipeApi.models.securitymodels;
import com.example.RecipeApi.models.UserMeta;
...
@Getter
@Setter
@Builder //(on website, but not in example repo)
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "user_details") // (on website, but not in example repo)
